...
require (
	buf.build/gen/go/parca-dev/parca/connectrpc/go v1.19.1-20260225102827-5fda07223114.2 // @grafana/observability-traces-and-profiling
	buf.build/gen/go/parca-dev/parca/protocolbuffers/go v1.36.10-20260225102827-5fda07223114.1 // @grafana/observability-traces-and-profiling
